...
#'
#' @examples
helperDynNetpar <- function(structural.model, measurement.model, Time, Tentry ="Tentry", Event = "Event", StatusEvent = "StatusEvent" ,basehaz = NULL, assoc=NULL,subject, data){
  ...
  par_obj <- parskeleton(K=K, nD = nD,mapping.to.LP=mapping.to.LP,nL=nL,mapping.to.LP2=mapping.to.LP2, vec_ncol_x0n, n_col_x, nb_RE, indexparaFixeUser = indexparaFixeUser, 
